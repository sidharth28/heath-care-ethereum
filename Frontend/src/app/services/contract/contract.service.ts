...
export class ContractService {
  ...
  registerPatient(originAccount, name, dob, gender) {
    const that = this;
  ...
  giveCreateOnlyAccessToDocter(originAccount, address) {
    const that = this;
    ...
    return new Promise((resolve, reject) => {
      ...
      healthContract.deployed().then((instance) => {
        console.log("instance", instance);
        return instance.giveCreateOnlyAccessToDocter(
          address,
          {
            from: originAccount,
            value: '0'
  ...
  revokeCreateOnlyAccessToDocter(originAccount, address) {
    const that = this;
    ...
    return new Promise((resolve, reject) => {
      ...
      healthContract.deployed().then((instance) => {
        console.log("instance", instance);
        return instance.revokeCreateOnlyAccessToDocter(
          address,
          {
            from: originAccount,
            value: '0'
  ...
  giveViewOnlyAccessToDocter(originAccount, address) {
    const that = this;
    ...
    return new Promise((resolve, reject) => {
      ...
      healthContract.deployed().then((instance) => {
        console.log("instance", instance);
        return instance.giveViewOnlyAccessToDocter(
          address,
          {
            from: originAccount,
            value: '0'
  ...
  revokeViewOnlyAccessToDocter(originAccount, address) {
    const that = this;
    ...
    return new Promise((resolve, reject) => {
      ...
      healthContract.deployed().then((instance) => {
        console.log("instance", instance);
        return instance.revokeViewOnlyAccessToDocter(
          address,
          {
            from: originAccount,
            value: '0'
  ...
  getDoctersWithCreateOnlyAccess(originAccount) {
    const that = this;
    ...
    return new Promise((resolve, reject) => {
      ...
      healthContract.deployed().then((instance) => {
        console.log("instance", instance);
        return instance.getDoctersWithCreateOnlyAccess(
          {
            from: originAccount,
            value: '0'
          });
  ...
  getDoctersWithViewOnlyAccess(originAccount) {
    const that = this;
    console.log("account origin ", originAccount)
    return new Promise((resolve, reject) => {
      const healthContract = contract(tokenAbi);
      ...
      healthContract.deployed().then((instance) => {
        console.log("instance", instance);
        return instance.getDoctersWithViewOnlyAccess(
          {
            from: originAccount,
            value: '0'
          });
  ...
  getDoctersDetails(originAccount, address) {
    const that = this;
    console.log("account origin ", originAccount)
    return new Promise((resolve, reject) => {
      const healthContract = contract(tokenAbi);
      ...
      healthContract.deployed().then((instance) => {
        console.log("instance", instance);
        return instance.docters(address,
          {
            from: originAccount,
            value: '0'
          });
  ...
  getAllDoctor(originAccount) {
    ...
    return new Promise((resolve, reject) => {
      ...
      healthContract.deployed().then((instance) => {
        console.log("instance", instance);
        return instance.docters('0x3c41749F9eCDF5247e3639Cd15acc6514264e039',
          {
            from: originAccount,
            value: '0'
          });
